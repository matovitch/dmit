...
{
    auto integer       = makeParserTokenUnary <TOKEN_TREE_NODE_KIND_PAIR(LIT_INTEGER )> (_pool, _state);
    auto decimal       = makeParserTokenUnary <TOKEN_TREE_NODE_KIND_PAIR(LIT_DECIMAL )> (_pool, _state);
    ...
    integer       = tok<lex::Token::LIT_INTEGER     >();
    decimal       = tok<lex::Token::LIT_DECIMAL     >();
